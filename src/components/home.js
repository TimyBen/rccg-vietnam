  ...
  return (
    <div className="h-full">
      <div className="w-full h-full mx-auto">
        ...
        <div className="w-full sm:h-[34vh] md:h-full">
          <div className="slide-container w-full">
            <Fade className="w-full h-full">
              <div className="each-fade sm:h-[34vh] lg:h-[45rem]">
                <img
                  className="w-full lg:h-[50rem] sm:h-[35vh] max-[420px]:h-[25vh] aspect-auto object-fill bg-center bg-contain bg-no-repeat blur-[2px]"
                  src={Img_1}
                  alt=""
                />
                <div className="absolute  sm:h-[35vh] lg:h-[45rem] flex justify-center items-center  top-0 w-full ">
                  ...
                  <div className="h-full font-serif font-medium w-full lg:py-32 lg:px-32 bg-[#1d30411a] text-[#ffffff] flex justify-center items-center ">
                    <h1 className="w-[60rem] animate-fade sm:h-[35rem] h-[55vh] text-[3rem] max-[420px]:text-base text-center rounded-lg uppercase leading-loose antialiased bg-[#0104063c] tracking-wide description flex justify-center items-center">
              ...
              <div className="each-fade sm:h-[34vh] lg:h-[45rem]">
                ...
                <div className="absolute flex justify-center items-center  top-0 w-full h-full">
                  <div className="h-full  font-serif font-medium w-full lg:py-32 lg:px-32 bg-[#24354512] text-[#f4faff] flex justify-center items-center ">
                    <h1 className="w-[60rem] animate-fade sm:h-[35rem] h-[55vh] text-[3rem] max-[420px]:text-base text-center rounded-lg uppercase leading-loose antialiased bg-[#01040622] tracking-wide description flex justify-center items-center">
