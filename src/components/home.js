          ...
          <div className="slide-container w-full">
            <Fade className="w-full h-full">
              <div className="each-fade sm:h-[35vh] lg:h-[75vh]">
                <img
                  className="w-full lg:h-[75vh] max-[420px]:h-[35vh] aspect-auto object-fill bg-center bg-contain bg-no-repeat blur-[2px]"
                  src={Img_1}
                  alt=""
                />
                <div className="absolute sm:h-[35vh] lg:h-[75vh] flex justify-center items-center top-0 w-full">
                  <div className="h-full  font-serif font-medium w-full lg:py-32 lg:px-20 bg-[#24354512] text-[#f4faff] flex justify-center items-center ">
                    <h1 className="w-[60rem] animate-fade h-[35vh] lg:h-[75vh] sm:h-[35vh] max-[420px]:h-[25vh] text-[3rem] max-[420px]:text-base text-center rounded-lg uppercase leading-loose antialiased bg-[#01040622] tracking-wide description flex justify-center items-center">
              ...
              <div className="each-fade sm:h-[45vh] lg:h-[75vh]">
                <img
                  className="w-full lg:h-[75vh] max-[420px]:h-[15vh] object-fill aspect-auto bg-center bg-contain bg-no-repeat brightness-5 blur-[0.5px]"
                  src={Img_2}
                  alt=""
                />
                <div className="absolute sm:h-[35vh] lg:h-[75vh] flex justify-center items-center top-0 w-full">
