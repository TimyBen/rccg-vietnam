      ...
      <div className="w-full">
        <div className="w-full min-h-[35rem] flex max-[420px]:flex-col max-lg:flex-col justify-between bg-gradient-to-r from-[#015c64] to-[#042549] items-center py-12 px-12 text-white ">
          <div className="w-[25rem] border-4 h-full p-6  hover:bg-[#1e4b55a9] ease-linear transform transition duration-500 rounded-lg flex justify-center items-center flex-col">
            <h1 className="font-climate font-semibold text-[2rem] text-center leading-loose tracking-wider max-[420px]:text-xs">About Our Church</h1>
            <p className="font-serif text-left indent-5 text-xl leading-relaxed max-[420px]:text-xs">Harvest Center Parish Vietnam is a Parish of the The Redeemed Christian Church of God ( RCCG ) VIETNAM. We have been in Vietnam since 2013 , ministering to the spiritual needs of those who are heavy burden and desirous of a relationship with our Lord and Savior Jesus Christ.</p>
          </div>
          ...
          <div className="w-[25rem] border-4 h-full p-6 hover:bg-[#1b3850c8] ease-linear transform transition duration-500 rounded-lg flex justify-center content-center pt-16 flex-col">
            <h1 className="font-climate font-semibold text-[2rem] text-center tracking-wider max-[420px]:text-base">Worship Center</h1>
            <div className="w-full h-72 flex flex-col justify-center items-center gap-2">
              <div className="w-full px-8 pb-4 flex flex-col justify-between gap-2 items-center">
                ...
                <p className="font-serif text-xl text-left flex-grow max-[420px]:text-xs">Q7, HCMC Vietnam</p>
              </div>
              <div className="w-full px-8 pb-4 flex flex-col justify-between items-center">
                <TbPhoneCall className="w-6 h-6" />
                <p className="font-serif text-xl text-left flex-grow max-[420px]:text-xs">+84 077 375 5307</p>
              </div>
              <div className="w-full px-8 pb-4 flex flex-col justify-between items-center">
                <TbMail className="w-6 h-6" />
                <p className="font-serif text-xl text-left flex-grow max-[420px]:text-xs">rccg.vietnam@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
